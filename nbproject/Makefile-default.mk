...
${OBJECTDIR}/appNet.o: appNet.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/appNet.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -DICD3PlatformTool=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -funroll-loops -fno-schedule-insns -mcci -MMD -MF "${OBJECTDIR}/appNet.o.d" -o ${OBJECTDIR}/appNet.o appNet.c   -relaxed-math -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/appNet.o: appNet.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/appNet.o.d 
	@${RM} ${OBJECTDIR}/appNet.o 
	@${FIXDEPS} "${OBJECTDIR}/appNet.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -funroll-loops -fno-schedule-insns -mcci -MMD -MF "${OBJECTDIR}/appNet.o.d" -o ${OBJECTDIR}/appNet.o appNet.c   -relaxed-math -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
